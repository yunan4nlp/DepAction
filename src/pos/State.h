...
public:
	...
	void arcLeft(CState *next, const string &relation) {
		...
		_cur_action_str = to_string(top1) + "_" + to_string(top0) + "_" + relation;
	}
	//right action	
	void arcRight(CState *next, const string &relation) {
		...
		_cur_action_str = to_string(top0) + "_" + to_string(top1) + "_" + relation;
	}
	// pop root action
	void popRoot(CState *next, const string &relation) {
		...
		_cur_action_str = to_string(top0) + "_" + to_string(_word_size) + "_" + "root";
	}
